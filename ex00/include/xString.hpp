...
/*   Updated: 2024/05/27 18:49:22 by mogawa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	//! wrapper functions
	// bool		contain_not_of(std::string const &to_search, size_type pos = 0) const;
	bool		contain_not_of(std::string const &to_search, size_type start = 0, size_type end = std::string::npos) const;
	// bool		contain_not_of(char const *to_search, size_type pos = 0) const;
	// bool		contain_any_of(std::string const &to_search, size_type pos = 0) const;
	bool		contain_any_of(std::string const &to_search, size_type start = 0, size_type end = std::string::npos) const;
	// bool		contain_any_of(char const *to_search, size_type pos = 0) const;
