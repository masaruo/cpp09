...
/*   Updated: 2024/05/19 22:41:24 by mogawa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	//! wrapper functions
	bool		contain_not_of(std::string const &to_search, std::size_t pos = 0) const;
	bool		contain_not_of(char const *to_search, std::size_t pos = 0) const;
	bool		contain_any_of(std::string const &to_search, std::size_t pos = 0) const;
	bool		contain_any_of(char const *to_search, std::size_t pos = 0) const;
